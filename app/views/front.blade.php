               ...
               <div class="large-7 large-centered columns">
                ...
                <div class="large-7 large-centered columns">
                  <div class="large-6 columns">
                    <input type="radio" name="siteSearch" value="/halloween/q?query=" id="forthis"><label for="forthis">Search this page</label>
                  </div>
                  <div class="large-6 columns">
      ...
      <div class="row">
          <ul style="display:hidden" class="pagination">
            ...
            if(isset($_GET['page'])){
             ...
             ?>
              @if($isQueryPage)
                <li><a {{($curr == $num) ? 'class="active"' : ''}} href="http://www.become.com/halloween/q?query={{$query}}&"></a></li>
              @else
